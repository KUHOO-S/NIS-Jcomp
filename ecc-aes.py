...
#defining ECC params
p =
89489622076502325516566028151591534221626096440983545113445971872000570104135524
39917934304191956942765446530386427345937963894309923928536070534607816947
a =
62948605579730632276664213064763793240747157706227462271369104454503019142812760
98027990968407983962691151853678563877834221834027439718238065725844264138
b =
32457890083289670592748495843420779165319090096375019183283236687361791765832634
96463525128488282611559800773506973771797764811498834995234341530862286627
x0 =
67920591404245751744356404312691950878431533901025218814680230127320474825798530
77545647446272866794936371522410774532686582484617946013928874296844351522
y0 =
65922445552401128733247483814296103413127129403262663313274450666870105454152564
61097707483288650216992613090185042957716318301180159234788504307628509330
G = [x0, y0]
#defining private keys
alpha =
bin(9426890448883247745626185743057242473809693764078951663494238777294707070023
223798882976159207729119823605850588608460429412647567360897409117209856022401)[
2:][::-1]
beta =
bin(9619275968248211985332842594956369871234381391917297615810447731933374561248
187549880587917558907265126128418967967816764706783230897486752408974005133)[2:][:
:-1]
#public key of recvr
...
edef = time.time()
se = time.time()
testImg = "C:/Users/Pushpak/Desktop/Cyber/res/eggs.png"
...
for i in range(width):
 ...
 Bx = 255-cB[-1]
 eI[i, j] = (Rx, Gx, Bx)
encryptedImg.save("C:/Users/Pushpak/Desktop/Cyber/res/Encrypted/encryptedAES.png")
ee = time.time()
#Decryption
sd = time.time()
step = grpSize+1
encrypted = Image.open("C:/Users/Pushpak/Desktop/Cyber/res/Encrypted/encryptedAES.png")
...
for i in range(h):
 ...
 k += 1
decryptedImg.save('C:/Users/Pushpak/Desktop/Cyber/res/Decrypted/decryptedAES.png')
ed = time.time()
