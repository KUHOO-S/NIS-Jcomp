...
def ECC_Encryption():
    ...
    #print("exit ecc encryptipm")
    #print(len(cipherImg1))
...
def ECC_Decryption():
    ...
    #print("ecc dec end")
    #print(type(pTList1))
    #print(type(pTList1[0]))
    return pTList1, pTList2, pTList3



#*******************************************************************************************
#START CODEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEE
#*******************************************************************************************
...
for i in range(width):
    for j in range(height):
        if k < lenCi:
            ...
            Bx = 255-cB[-1]
            eI[i, j] = (Rx, Gx, Bx)
encryptedImg.save("./encryptedAES_ECC.png")
ee = time.time()
# Decryption
sd = time.time()
step = grpSize+1
encrypted = Image.open("./encryptedAES_ECC.png")
...
for i in range(h):
    for j in range(w):
        ...
        k += 1
decryptedImg.save('./decryptedAES_ECC.png')
ed = time.time()
#print(w,h)
